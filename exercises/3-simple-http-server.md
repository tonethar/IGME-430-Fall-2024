...
- **Continuous Integration** with **GitHub Actions**
  ...
  - If we check the "Wait for CI to pass before deploy" on Heroku - the new GitHub code will NOT be deployed to the running version on Heroku if it fails `npm test`!
