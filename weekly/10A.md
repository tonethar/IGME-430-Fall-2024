...
## III. Demo: Server-side rendering with `express` & `express-handlebars`
...
### III-C. Look in views/index.handlebars

- Check out the title tag `<title>{{title}}</title>`


### III-D. controllers/index.js
...
### III-E. More for views/index.handlebars
...
## IV. Demo: More rendering with handlebars - loops & conditionals
