...
- 10B - MongoDB! See the **MongoDBCloudSetup** PDF in myCourses Week-10, and [How to use MongoDb Compass](https://www.mongodb.com/docs/compass/current/) (which is an easy to use admin/client app for MongoDB)
